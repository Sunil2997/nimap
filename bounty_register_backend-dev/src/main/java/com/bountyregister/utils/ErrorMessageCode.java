...
public class ErrorMessageCode {
	...
	public static final String LEARNING_TRACK_TRAINER_ID_REQUIRED = "At least one Trainer ID must be specified.";
	...
	public static final String TRAINER_NOT_PRESENT = "Trainer not present";
	public static final String TRAINER_NAME_REQUIRED = "Trainer name required";
	...
	public static final String TRACK_TRAINER_ID_NOT_FOUND = "Track trainer  not found";
	public static final String TRAINER_ALREADY_ASSIGN_TO_TRACK = "trainer already assign to learning track";
	...
	public static final String INVALID_TRAINER_NAME = "Trainer name is not same as username";
	...
	public static String TRAINER_ALREADY_PRESENT = "Trainer already present";
