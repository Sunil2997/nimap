...
import com.bountyregister.serviceImpl.CustomUserDetailService;
...
public class WebSecurity {
	...
	//	sunil changes	//	.antMatchers(ApiUrls.SWAGGER_URLS).permitAll().anyRequest().authenticated().and().httpBasic().and()

				//Changes made by me
				.anyRequest().permitAll().and()
			
				//above code change by sunil
